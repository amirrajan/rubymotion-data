...
@property unsigned int tapCount; // @synthesize tapCount=_tapCount;
...
- (id)_scriptingStringForOffsetWithScreenPoint:(CGPoint)arg1 inRect:(CGRect)arg2;
- (id)_scriptingStringForPoint:(CGPoint)arg1;
...
- (void)postElementNotFoundAtPoint:(CGPoint)arg1 description:(id)arg2;
