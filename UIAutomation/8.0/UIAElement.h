...
+ (id)elementAtPosition:(CGPoint)arg1;
...
+ (id)_jsStringForRect:(CGRect)arg1;
+ (id)_jsStringForPoint:(CGPoint)arg1;
...
+ (CGPoint)_convertPointToCurrentInterfaceOrientation:(CGPoint)arg1;
+ (CGPoint)_convertPointFromCurrentInterfaceOrientation:(CGPoint)arg1;
+ (CGRect)_convertRectFromCurrentInterfaceOrientation:(CGRect)arg1;
+ (CGRect)_convertRectToCurrentInterfaceOrientation:(CGRect)arg1;
+ (CGAffineTransform)_transformToRotateToInterfaceOrientation:(NSInteger)arg1;
+ (CGAffineTransform)_transformToRotateFromInterfaceOrientation:(NSInteger)arg1;
+ (id)allKeys;
...
+ (void)_logVerbosity:(NSUInteger)arg1 format:(id)arg2;
...
- (id)_elementAtPosition:(CGPoint)arg1;
- (id)_elementForUIAXElement:(id)arg1;
- (id)_inspectedElementForAXAncestry:(id)arg1 index:(NSUInteger *)arg2 triedKeys:(id)arg3;
- (id)_inspectedToManyRelationship:(id)arg1 forAXAncestry:(id)arg2 index:(NSUInteger *)arg3;
- (id)_inspectedToOneRelationship:(id)arg1 forAXAncestry:(id)arg2 index:(NSUInteger *)arg3;
- (BOOL)_inspectConfirmElement:(id)arg1 forAXAncestry:(id)arg2 index:(NSUInteger *)arg3;
...
- (id)_scriptingSynonymsForSubElement:(id)arg1 maxCount:(NSUInteger)arg2;
...
- (void)doubleTap;
- (void)tap;
- (BOOL)_prepareForAction:(SEL)arg1;
