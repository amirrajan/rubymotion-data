...
#if defined(__LP64__)
MKAnnotationViewZPriority __concrete__MKAnnotationViewZPriorityDefaultSelected asm ("_MKAnnotationViewZPriorityDefaultSelected") = 1000;

#endif

#if defined(__LP64__)
MKAnnotationViewZPriority __concrete__MKAnnotationViewZPriorityDefaultUnselected asm ("_MKAnnotationViewZPriorityDefaultUnselected") = 500;

#endif

#if defined(__LP64__)
MKAnnotationViewZPriority __concrete__MKAnnotationViewZPriorityMax asm ("_MKAnnotationViewZPriorityMax") = 1000;

#endif

#if defined(__LP64__)
MKAnnotationViewZPriority __concrete__MKAnnotationViewZPriorityMin asm ("_MKAnnotationViewZPriorityMin") = 0;
